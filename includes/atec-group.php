...
<div class="atec-page">';
	...
	<div class="atec-main">';
		...
		if ($license=='true')
		{
			atec_little_block(__('atec-Plugins „PRO“ package','atec-system-info'));
			echo '
			<div class="atec-g atec-border atec-center" style="padding: 20px 10px;">
				<h3 class="atec-mt-0">
					...
					esc_attr__('atec-Plugins „PRO“ package','atec-system-info'), 
				'</h3>
				<div id="atec_group_pro_package">
					<div id="pro_package_welcome" class="atec-fit" style="margin: 0 auto;">
						<div class="atec-mt-5 atec-border-white atec-bg-w atec-fit" style="font-size: 16px !important; padding: 10px;">
							<ul class="atec-m-0">
							<li>⭐ ', esc_attr__('21 valuable plugins','atec-system-info'), '.</li>					
							<li>⭐ ', esc_attr__('Access to all the „PRO“ features','atec-system-info'), '.</li>
							<li>⭐ ', esc_attr__('„Lifetime-site-License“ for your site (domain)','atec-system-info'), '.</li>
							</ul>
						</div>
					</div>
				<br>';
			...
			<button class="button button-primary">', esc_attr__('GET YOUR „PRO“ PACKAGE NOW','atec-system-info'), '</button></a>
			...
			echo '<p styl="font-size: 18px !important;">',
				esc_attr__('Buy the „PRO“ package through one time payment','atec-system-info'), '.<br>',
				esc_attr__('The license is valid for the lifetime of your site (domain)','atec-system-info'), '.<br><b>',
				esc_attr__('No subscription. No registration required.','atec-system-info'), '</b>
			</p>
			</div>';
		...
		$atec_review			= ['webp'];
		$atec_desc_arr		= [
							__('All-in-one Backup and restore solution – fast & reliable','atec-system-info'),
							...
							__('Ads SVG support for media uploads.','atec-system-info'),
							__('Manage WordPress User Roles and Capabilities','atec-system-info'),
		...
		<center>
			<p class="atec-fs-10" style="max-width:80%;">',
				...
				esc_attr__('With an average of 1 ms CPU time, we consider our plugins to be super fast – other plugins typically require much more time','atec-system-info'), '.<br>',
				esc_attr__('OSs supported: Linux (CloudLinux, Debian, Ubuntu), Windows & Mac-OS','atec-system-info'), '.<br>',
				esc_attr__('Webservers tested: Apache, NGINX & LiteSpeed','atec-system-info'), '.
			</p>
