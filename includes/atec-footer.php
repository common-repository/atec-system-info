...
<div class="atec-footer atec-center atec-fs-12">
	<span class="atec-ml-10" style="float:left;">
		<span class="atec-fs-12" title="', esc_attr__('Execution time','atec-system-info'), '">
		...
		</span> &middot; <a class="atec-nodeco" href="',esc_url(get_admin_url().'admin.php?page=atec_group'),'">atec-',  esc_attr__('plugins','atec-system-info'), ' – ', esc_attr__('Dashboard','atec-system-info'), '</a>
	</span>
